...
foreach ($arrTestListByBook as $key => $arrResult) {
	...
	$arrTestListByBook[$key]['my_record_list'] = $objRecord->getMemberRecords($strStudentKey,$arrResult['test_seq']);
}
...
$arr_output['student_key'] = $strStudentKey;
