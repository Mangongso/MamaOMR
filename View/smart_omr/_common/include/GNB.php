...
<button class="uk-button uk-navbar-flip _d_logout"><i class="fa fa-user" aria-hidden="true"></i></button>
<? }else{ ?>
<button class="uk-button uk-navbar-flip" data-uk-offcanvas="{target:'#LOGIN'}"><i class="fa fa-user" aria-hidden="true"></i></button>
<? } ?>
</div>
<!-- Top GNB START -->
</nav>
    ...
    <div id="menu">
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                ...
                <? if($_SESSION['smart_omr']['member_key']){ ?>
                <li class="pure-menu-item <?=$viewID=="SOMR_REG_MANAGER"?'active':''?>"><a href="/smart_omr/registration/manager" class="pure-menu-link"><i class="fa fa-eye" aria-hidden="true"></i>학습 매니저 등록</a></li>
