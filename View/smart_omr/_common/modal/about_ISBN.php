<!-- Modal -->
<div id="about_ISBN" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="location='/smart_omr/exercise_book/registration_detail_activation.php'" class="btn btn-primary btn-lg  col-xs-6"><i class="fa fa-plus" aria-hidden="true"></i> 만들기</button>
      </div>
    </div>
  </div>
</div>
