...
<div class="workbook_cover col-xs-12 col-sm-6 col-md-4 col-lg-3">
	<div class="workbook_cover_box">
		<div class="fit_target" style="height: 290px;">
			<a
				href="/smart_omr/exercise_book/detail.php?bs=<?=md5($arrBook['seq'])?>"><img
				class="fit_image" src="<?=$arrBook['book_cover_img']?>"
				alt="<?=$arrBook['title']?>" />
			<p class="sr-only"><?=$arrHeader['title']?></p></a>
		</div>
		...
		<div class="col-xs-12 content_body_list">
			...
			<a
				href="/smart_omr/exercise_book/detail.php?bs=<?=md5($arrBook['seq'])?>"
				class="pure-button pure-form_in col-lg-12 btn-lg btn-block content_header_list_bt"><i
