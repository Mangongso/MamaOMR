...
<div id="LOGIN" class="uk-offcanvas">
    <div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		<div class="list-group etc_login">
            ...
            <a href="javascript:void(0);" onclick="$('#naver_id_login_anchor').click();" class="list-group-item login_naver"><span><img src="/smart_omr/_images/naver_logo.png" alt="Naver Logo" /></span>네이버 아이디로 로그인</a>
