<? $viewID = "SOMR_MY_PAGE_MY_MANAGING_REPORT_DETAIL"; ?>
					...
					<ul>
						...
						<li>
					        ...
					        <li class="pure-menu-item">
					        	<a
											href="/smart_omr/exercise_book/test_result.php?t=<?=md5($arrTest['test_seq'])?>&revision=<?=$arrMyRecordList['revision']?>&sk=<?=$arr_output['student_key'];?>"
