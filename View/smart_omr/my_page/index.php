...
<div id="main">
        ...
        <div class="container-fluid mypage_container-fluid">
			...
			<? include("./_elements/mypage_tab.php"); ?>
				...
				<h4><i class="fa fa-arrow-right" aria-hidden="true"></i> 마이 페이지 / 나의 테스트 <br class="visible-xs"/><span>참여하신 테스트 목록입니다.</span></h4>
				</div>
				<!--#################################-->
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 my_page_box_in">
			  <div class="content_header_area sub_content_header_test_top">
			      <div class="col-xs-4 col-sm-5 col-md-5 col-lg-5 content_header_img">
			        <a href="/smart_omr/my_page/my_edu_report_detail.php?bs=<?=md5($arrBook['seq']);?>"><img src="<?=$arrBook['book_cover_img']?>" alt="<?=$arrBook['title']?>" class="content_cover_img"/><p class="sr-only"><?=$arrBook['title']?></p></a>
			      </div>
			      <div class="col-xs-8 col-sm-7 col-md-7 col-lg-7 content_body_list sub_content_body_list">
			        <ul>
			        	...
			        	<li><span><i class="fa fa-line-chart" aria-hidden="true"></i> 나의 점수</span><?=$arrBook['my_record'][0]['total_user_score']?><small>점</small></li>
