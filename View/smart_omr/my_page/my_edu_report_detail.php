...
<div id="main">
	...
	<a class="btn btn-success btn-lg work_book_reg_bt" href="/smart_omr/exercise_book/registration.php"><i class="fa fa-plus"aria-hidden="true"></i></a>
			...
			<div class="row content_body content_small_body">
				...
				<h4><?=$arrTest['subject']?><a class="uk-float-right uk-button uk-button-mini" href="/smart_omr/my_page/wrong_answer_notes.php?t=<?=md5($arrTest['test_seq'])?>">오답노트 <i class="fa fa-arrow-right" aria-hidden="true"></i></a></h4>
				<ul>
