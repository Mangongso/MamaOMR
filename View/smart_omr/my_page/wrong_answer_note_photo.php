...
<img src="./_images/question.php?p=<?=$arr_output['wrong_note'][0]['wrong_note_key']?>"/>
<input type="hidden" name="wrong_note_key" value="<?=$arr_output['wrong_note'][0]['wrong_note_key']?>"/>
