...
<img id="question_img" src="../_images/question.php?b=<?=$arr_output['book_seq'];?>&t=<?=$arr_output['wrong_note'][0]['test_seq']?>&q=<?=$arr_output['wrong_note'][0]['question_seq']?>&f=<?=$arr_output['wrong_note'][0]['file_name'];?>" data-img_mode="real"/>
...
<button id="btn_ocr" type="button" href="/smart_omr/exercise_book/list.php" class="pure-button pure-form_in col-xs-6 col-sm-6 col-md-6 col-lg-6 btn-lg content_header_list_bt"><i class="fa fa-random" aria-hidden="true"></i> 텍스트 추출</button>
</p>
...
<textarea name="question" id="question" style="width:100%;height:100px;padding: 20px;"><?=trim($strWrongNoteContents)?></textarea>
<div class="m-modal-bt-box">
<button id="btn_upload" type="submit" href="/smart_omr/exercise_book/test.php?t=<?=$arr_output['str_test_seq']?>" class="pure-button pure-form_in col-xs-6 col-sm-6 col-md-6 col-lg-6 btn-lg content_header_list_bt"><i class="fa fa-check" aria-hidden="true"></i> 저장</button>
<button id="btn_ocr" type="button" href="/smart_omr/exercise_book/list.php" class="pure-button pure-form_in col-xs-6 col-sm-6 col-md-6 col-lg-6 btn-lg content_header_list_bt"><i class="fa fa-times" aria-hidden="true"></i> 닫기</button>
</div>
</form>
<?php 
// print "<pre>";
