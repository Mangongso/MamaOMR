...
<div class="row">
	<div class="col-md-3 install_body etc_login">
		<ul>
			...
			<li><a href="#" class="list-group-item login_facebook" onclick="checkSnsLogin($(this).attr('sns_type'),$(this).attr('event_type'),$(this));" ><i class="fa fa-facebook-official" aria-hidden="true"></i>페이스북 아이디로 로그인</a></li>
			<? }?>
