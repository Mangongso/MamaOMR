		...
		<ul>
			...
			<li>
				<div class="h_dot_box info-box-ul install-info">
					<h2 class="install_mail">dan.yun@hanbnc.com</h2>
					<ul>
			...
			<li><a href="javascript:history.back();"
				class="list-group-item login_kakao"><i class="fa fa-refresh"></i>다른
					아이디로 로그인</a></li>
			<li><input class="form-control input-lg" type="text"
				placeholder="192.168.1.12"></li>
			<li><input class="form-control input-lg" type="text"
				placeholder="dan.yun" style="margin-top: -1px;"></li>
			<li><input class="form-control input-lg" type="text"
				placeholder="*************" style="margin-top: -1px;"></li>
