...
?>
				...
				<img id="question_img" src="../_images/question.php?b=<?=$arr_output['book_seq'];?>&t=<?=$arrWrongAnswer['test_seq']?>&q=<?=$arrWrongAnswer['question_seq']?>&f=<?=$arrWrongAnswer['file_name']?>" data-img_mode="real"/>
				<? }else if($arrWrongQuestionDetail['file_name']){?>
				<img id="question_img" src="../_images/question.php?b=<?=$arr_output['book_seq'];?>&t=<?=$arrWrongAnswer['test_seq']?>&q=<?=$arrWrongAnswer['question_seq']?>&f=<?=$arrWrongQuestionDetail['file_name']?>" data-img_mode="real"/>
				<? }else{ ?>
				...
				<? }else{ ?>
				<div><?=$arrWrongAnswer['order_number']?>. 등록된 내용이 없습니다.</div>
				<? } ?>
