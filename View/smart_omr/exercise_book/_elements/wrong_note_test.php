...
<div class="quiz-question"  question_seq="<?=$arrWrongAnswer['question_seq']?>" style="display:<?=$intIndex==0?'block':'none';?>">
		...
		style="width: 100%; height: 250px;" alt=" " />
				...
				<? }else{ ?>
				<div class="h_dot">
		<div class="h_dot_box test_score"><?=$arrWrongAnswer['order_number']?>. 등록된 내용이 없습니다.</div>
	</div>
				<? } ?>
		...
		<div
			class="uk-width-8-10 btn-group ans_correct ans_correct_<?=$arrWrongQuestionDetail['question_type'];?>"
			data-toggle="buttons">
						<?
...
<? $intIndex++; ?>
				...
				<? }else{ ?>
<div class="h_dot">
	<div class="h_dot_box test_score">틀린 문제가 없습니다.</div>
</div>
<!-- ######## -->
<? } ?>
