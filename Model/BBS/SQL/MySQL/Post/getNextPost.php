...
if(is_numeric($arr_input[bbs_seq])){$arr_where[]="a.bbs_seq='".$arr_input[bbs_seq]."'";}
...
$this->query["get_next_post"] = sprintf("select 
seq,
subject,
...
where bbs_seq=%d and seq<%d $str_where order by seq DESC limit 0,1",$arr_input[bbs_seq],$arr_input[seq]);
?>